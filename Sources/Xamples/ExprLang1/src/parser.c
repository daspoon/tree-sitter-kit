...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_Expr_name, 1),
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_Expr_paren, 3),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_Expr_apply, 3),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ExprList, 1),
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_Expr_add, 3),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_Expr_mul, 3),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_Expr_pow, 3),
  ...
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_ExprList_repeat1, 2), SHIFT_REPEAT(5),
