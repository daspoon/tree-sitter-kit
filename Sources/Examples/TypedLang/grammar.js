module.exports = grammar({
    ...
    rules: {
        ...
        Expr_add: $ => prec.left(4, seq(field('0', $._Expr), field('1', $.OpAdd), field('2', $._Expr))),
        Expr_and: $ => prec.left(3, seq(field('0', $._Expr), field('1', $.OpConj), field('2', $._Expr))),
        Expr_block: $ => seq('{', field('0', $.Block), '}'),
        Expr_call: $ => prec.left(9, seq(field('0', $._Expr), '(', field('1', optional($.ExprSequenceSeparatedByComma)), ')')),
        Expr_eql: $ => prec.left(1, seq(field('0', $._Expr), field('1', $.OpCmp), field('2', $._Expr))),
        ...
        Expr_mul: $ => prec.left(5, seq(field('0', $._Expr), field('1', $.OpMul), field('2', $._Expr))),
        Expr_name: $ => field('0', $.Name),
        Expr_neg: $ => prec(7, seq(field('0', $.OpNeg), field('1', $._Expr))),
        Expr_numb: $ => field('0', $.Int),
        Expr_or: $ => prec.left(2, seq(field('0', $._Expr), field('1', $.OpDisj), field('2', $._Expr))),
        Expr_paren: $ => seq('(', field('0', optional($.ExprSequenceSeparatedByComma)), ')'),
        Expr_pow: $ => prec.right(6, seq(field('0', $._Expr), field('1', $.OpPow), field('2', $._Expr))),
